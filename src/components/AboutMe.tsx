...
const paragraphs = [
  {
    ...
    description:
      "I'm a Software Engineer at Crest Data Systems, passionate about frontend development. Always eager to broaden my skill set, I actively pursue learning new technologies regularly.",
    icon: hardwareicon,
  },
  {
    title: "Let's Connect",
    description:
      "Exploring New Opportunities! My inbox is always open—whether you have questions or just want to say hi, feel free to reach out!",
    icon: travelicon,
  },
];
        ...
        <div className="flex flex-row justify-center gap-6 items-center pl-32 pr-32 mb-16  max-lg:flex-col max-lg:p-16 min-[1921px]:px-[45rem] min-[1921px]:mb-48">
          ...
          >
            {paragraphs.map((paragraph, index) => (
              <SwiperSlide
                className="bg-[--darkblue] text-[--white] flex flex-col justify-center items-start gap-24 rounded-2xl p-20 border-solid border-[0.4rem] border-[--lightblue] hover:border-blue duration-500 transition-all text-left max-lg:p-10 cursor-grab"
                key={index}
              >
                ...
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  <div className="flex flex-col gap-4 items-center justify-between -mt-10 -mb-10 max-lg:flex-row max-lg:m-0">
                    <p className="text-white">
                      <span className="text-blue">&lt;</span>h3
                      <span className="text-blue">/&gt;</span>
                    </p>
            ...
            <div
              className="autoplay-progress absolute right-0 bottom-0 z-10 flex items-center justify-center font-bold text-blue text-4xl w-24 h-24 max-lg:w-16 max-lg:h-16 max-lg:text-3xl "
              slot="container-end"
            >
